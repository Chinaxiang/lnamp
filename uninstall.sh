...
echo "/lnamp/server/mysql             delete ok!" 
rm -rf /lnamp/server/mysql
echo "rm -rf /lnamp/server/mysql-*    delete ok!"
rm -rf /lnamp/server/mysql-*
echo "/lnamp/server/php               delete ok!"
rm -rf /lnamp/server/php
echo "/lnamp/server/php-*             delete ok!"
rm -rf /lnamp/server/php-*
echo "/lnamp/server/nginx             delete ok!"
rm -rf /lnamp/server/nginx
echo "rm -rf /lnamp/server/nginx-*    delete ok!"
rm -rf /lnamp/server/nginx-*
echo "/lnamp/server/httpd             delete ok!"
rm -rf /lnamp/server/httpd
echo "/lnamp/server/httpd-*           delete ok!"
rm -rf /lnamp/server/httpd-*
echo ""
echo "/lnamp/log/php                  delete ok!"
rm -rf /lnamp/log/php
echo "/lnamp/log/mysql                delete ok!"
rm -rf /lnamp/log/mysql
echo "/lnamp/log/nginx                delete ok!"
rm -rf /lnamp/log/nginx
echo "/lnamp/log/httpd                delete ok!"
rm -rf /lnamp/log/httpd
...
sed -i "/export PATH=\$PATH\:\/lnamp\/server\/mysql\/bin.*/d" /etc/profile
source /etc/profile
