...
if [ ! -f libiconv-1.13.1.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/libiconv-1.13.1.tar.gz
fi
...
if [ ! -f zlib-1.2.3.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/zlib-1.2.3.tar.gz
fi
rm -rf zlib-1.2.3
...
if [ ! -f freetype-2.1.10.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/freetype-2.1.10.tar.gz
fi
...
if [ ! -f libpng-1.2.50.tar.gz ];then
  wget http://res1.coder4j.com/onekey/lib/libpng-1.2.50.tar.gz
fi
rm -rf libpng-1.2.50
...
if [ ! -f libevent-1.4.14b.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/libevent-1.4.14b.tar.gz
fi
...
if [ ! -f libmcrypt-2.5.8.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/libmcrypt-2.5.8.tar.gz
fi
...
if [ ! -f pcre-8.12.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/pcre-8.12.tar.gz
fi
rm -rf pcre-8.12
...
if [ ! -f jpegsrc.v6b.tar.gz ];then
	wget http://res1.coder4j.com/onekey/lib/jpegsrc.v6b.tar.gz
fi
rm -rf jpeg-6b
